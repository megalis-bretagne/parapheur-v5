...
Feature: ACTES-PAdES - Signature - PDF_sans_tags-signature_pades - signe_pades

    Background:
        * ip.pause(2)
        * def type = "ACTES - PAdES"
        * def subtype = "Signature"
        * def name = "ACTES-PAdES - Signature - PDF_sans_tags-signature_pades"
        * def files = [ { file: "classpath:files/formats/PDF_sans_tags/PDF_sans_tags-signature_pades.pdf" } ]
