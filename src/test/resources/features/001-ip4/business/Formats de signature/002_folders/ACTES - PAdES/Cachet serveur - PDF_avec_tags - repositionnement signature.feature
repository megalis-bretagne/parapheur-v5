...
Feature: ACTES - PAdES - Cachet serveur - PDF_avec_tags - repositionnement signature

    Background:
        * ip.pause(2)
        * def type = "ACTES - PAdES"
        * def subtype = "Cachet serveur"
        * def name = "ACTES - PAdES - Cachet serveur - PDF_avec_tags - repositionnement signature"
