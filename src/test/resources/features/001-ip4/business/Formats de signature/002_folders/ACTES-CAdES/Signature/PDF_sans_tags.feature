...
Feature: ACTES-CAdES - Signature - PDF_sans_tags

    Background:
        * ip.pause(2)
        * def type = "ACTES - CAdES"
        * def subtype = "Signature"
        * def name = "ACTES-CAdES - Signature - PDF_sans_tags"
    ...
    Scenario Outline: Vérifications de la liste des documents (${key})
        ...
        * match download.files == [ "PDF_sans_tags.pdf", "PDF_sans_tags.pdf-1-<user>.p7s" ]
