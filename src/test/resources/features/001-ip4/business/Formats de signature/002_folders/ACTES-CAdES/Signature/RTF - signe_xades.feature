...
Feature: ACTES-CAdES - Signature - RTF - signe_xades

    Background:
        * ip.pause(2)
        * def type = "ACTES - CAdES"
        * def subtype = "Signature"
        * def name = "ACTES-CAdES - Signature - RTF - signe_xades"
    ...
    Scenario Outline: Vérifications de la liste des fichiers (${key})
        ...
        * match download.files == [ "document_rtf.rtf", "document_rtf.rtf-0-signature_externe.xml", "document_rtf.rtf-1-<user>.p7s" ]
