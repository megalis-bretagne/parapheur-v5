    ...
    Scenario Outline: Create subtype "${name}" for type "${type}" and "${validationWorkflowId}" workflow in "${tenant}"
        * call read('classpath:lib/ip5/api/setup/subtype.create.feature') __row
        ...
        Examples:
            ...
            | Benoit XVI | COURRIERS          | Courrier à cacheter         | true                | false           | ['Application Générique', 'Service Finances', 'Service Informatique', 'Service des Marchés Publics', 'Service des Ressources Humaines'] |                    | CS_Pres                         |                           | true           | Entité initiale - Seal Certificate |                    | false                      |                                                                     | []                                        |
            | Benoit XVI | COURRIERS          | Courrier à signer Président | true                | false           | ['Application Générique', 'Service Finances', 'Service Informatique', 'Service des Marchés Publics', 'Service des Ressources Humaines'] | V_Chefde           | S_CS_Pres                       |                           | true           | Entité initiale - Seal Certificate |                    | true                       |                                                                     | []                                        |
