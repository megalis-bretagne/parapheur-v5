...
"""
      ...
      Examples:
          ...
          | ACTES HELIOS - grandes collectivités | ws-ahgc  | Ilenfautpeupouretreheureux  | WebService | ACTES - PAdES | ACTES - PAdES - Monodoc | 'classpath:files/pdf/main-1_1.pdf'         | ACTES - PAdES - Monodoc - sans annexe - %counter% | 1      | 10     | without       | {}                                | démarrage  |
          | ACTES HELIOS - grandes collectivités | ws-ahgc  | Ilenfautpeupouretreheureux  | WebService | ACTES - PAdES | ACTES - PAdES - Monodoc | 'classpath:files/pdf/main-1_1.pdf'         | ACTES - PAdES - Monodoc - avec annexe - %counter% | 1      | 10     | with          | {}                                | démarrage  |
          | ACTES HELIOS - grandes collectivités | ws-ahgc  | Ilenfautpeupouretreheureux  | WebService | HELIOS        | HELIOS - Monodoc        | 'classpath:files/xml/PESALR1_unsigned.xml' | HELIOS - Monodoc - sans annexe - %counter%        | 1      | 10     | without       | { "metadata":{"GdaBjType":"1"} }  | démarrage  |
          | ACTES HELIOS - grandes collectivités | ws-ahgc  | Ilenfautpeupouretreheureux  | WebService | HELIOS        | HELIOS - Monodoc        | 'classpath:files/xml/PESALR1_unsigned.xml' | HELIOS - Monodoc - sans annexe - %counter%        | 11     | 10     | without       | { "metadata":{"GdaBjType":"2"} }  | démarrage  |
          | ACTES HELIOS - grandes collectivités | ws-ahgc  | Ilenfautpeupouretreheureux  | WebService | HELIOS        | HELIOS - Monodoc        | 'classpath:files/xml/PESALR1_unsigned.xml' | HELIOS - Monodoc - sans annexe - %counter%        | 21     | 10     | without       | { "metadata":{"GdaBjType":"3"} }  | démarrage  |
          | ACTES HELIOS - grandes collectivités | ws-ahgc  | Ilenfautpeupouretreheureux  | WebService | HELIOS        | HELIOS - Monodoc        | 'classpath:files/xml/PESALR1_unsigned.xml' | HELIOS - Monodoc - avec annexe - %counter%        | 1      | 10     | with          | { "metadata":{"GdaBjType":"1"} }  | démarrage  |
          | ACTES HELIOS - grandes collectivités | ws-ahgc  | Ilenfautpeupouretreheureux  | WebService | HELIOS        | HELIOS - Monodoc        | 'classpath:files/xml/PESALR1_unsigned.xml' | HELIOS - Monodoc - avec annexe - %counter%        | 11     | 10     | with          | { "metadata":{"GdaBjType":"2"} }  | démarrage  |
          | ACTES HELIOS - grandes collectivités | ws-ahgc  | Ilenfautpeupouretreheureux  | WebService | HELIOS        | HELIOS - Monodoc        | 'classpath:files/xml/PESALR1_unsigned.xml' | HELIOS - Monodoc - avec annexe - %counter%        | 21     | 10     | with          | { "metadata":{"GdaBjType":"3"} }  | démarrage  |
          | ACTES HELIOS - grandes collectivités | ws-ahgc  | Ilenfautpeupouretreheureux  | WebService | ACTES - CAdES | ACTES - CAdES - Monodoc | 'classpath:files/pdf/main-1_1.pdf'         | ACTES - CAdES - Monodoc - sans annexe - %counter% | 1      | 10     | without       | {}                                | démarrage  |
          | ACTES HELIOS - grandes collectivités | ws-ahgc  | Ilenfautpeupouretreheureux  | WebService | ACTES - CAdES | ACTES - CAdES - Monodoc | 'classpath:files/pdf/main-1_1.pdf'         | ACTES - CAdES - Monodoc - avec annexe - %counter% | 1      | 10     | with          | {}                                | démarrage  |
