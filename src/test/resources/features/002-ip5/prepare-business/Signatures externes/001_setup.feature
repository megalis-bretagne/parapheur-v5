    ...
    Scenario Outline: Create subtype '${name}' for type '${type}' and '${validationWorkflowId}' workflow in '${tenant}'
        * call read('classpath:lib/ip5/api/setup/subtype.create.feature') __row
        ...
        Examples:
            ...
            | Signatures externes | Circuits      | Yousign - CS - SE            | true            | Cachet serveur - Signatures externes                                   | null           | Entité initiale - Seal Certificate |                    | Yousign                   |
            | Signatures externes | Circuits      | Yousign - S - SE             | true            | Signature - Signatures externes                                        | null           |                                    |                    | Yousign                   |
            | Signatures externes | Circuits      | Yousign - S - SE - SE - CS   | true            | Signature - Signatures externes - Signatures externes - Cachet serveur | null           | Entité initiale - Seal Certificate |                    | Yousign                   |
            | Signatures externes | Circuits      | Yousign - SE - CS            | true            | Signatures externes - Cachet serveur                                   | null           | Entité initiale - Seal Certificate |                    | Yousign                   |
