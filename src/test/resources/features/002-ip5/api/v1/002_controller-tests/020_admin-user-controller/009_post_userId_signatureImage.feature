    ...
    Scenario Outline: ${ip5.scenario.title.permissions(role, 'create a signature image for an existing user in an existing tenant', status)}
        ...
        * ip5.api.v1.auth.login('<username>', '<password>')
        ...
        Examples:
            ...
            | ADMIN            | cnoir        | a123456a123456  |                        | classpath:files/images/signature - stranslucide.png | 201    |
            | TENANT_ADMIN     | vgris        | a123456a123456  |                        | classpath:files/images/signature - stranslucide.png | 201    |
            | FUNCTIONAL_ADMIN | ablanc       | a123456a123456  | stranslucide@dom.local | classpath:files/images/signature - stranslucide.png | 403    |
            | NONE             | ltransparent | a123456a123456  | stranslucide@dom.local | classpath:files/images/signature - stranslucide.png | 403    |
