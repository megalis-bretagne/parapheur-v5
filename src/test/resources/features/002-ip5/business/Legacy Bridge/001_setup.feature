    ...
    Scenario Outline: Create subtype "${name}" for type "${type}" and "${validationWorkflowId}" workflow in "${tenant}"
        * call read('classpath:lib/ip5/api/setup/subtype.create.feature') __row
        ...
        Examples:
            ...
            | Legacy Bridge | PAdES         | cachet         | false               | false           | ['WebService']            |                    | Cachet               |                           | null           | Entité initiale - Seal Certificate |                    | true                       |                          | []                | []                                                                                           | false           |
            | Legacy Bridge | PAdES         | mailsec        | false               | false           | ['WebService']            |                    | Mailsec              |                           | null           | Entité initiale - Seal Certificate | Recette mailSec    | true                       |                          | []                | []                                                                                           | false           |
