...
Feature: XAdES det - Signature - PDF_sans_tags - signe_xades
    ...
    Background:
        ...
        * def name = "XAdES det - Signature - PDF_sans_tags - signe_xades"
    ...
    Scenario Outline: Vérifications des fichiers non signés (${key})
        ...
        * match karate.read("file://" + download.base + "/PDF_sans_tags-0-signature_externe.xml") == ip.commonpath.read("PDF_sans_tags/signature_xades.xml")
