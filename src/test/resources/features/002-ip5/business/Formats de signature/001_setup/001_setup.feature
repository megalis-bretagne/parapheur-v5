    ...
    Scenario Outline: Create subtype "${name}" for type "${type}" and "${validationWorkflowId}" workflow in "${tenant}"
        * call read('classpath:lib/ip5/api/setup/subtype.create.feature') __row
        ...
        Examples:
            ...
            | Formats de signature | ACTES - PAdES      | Cachet serveur               | false           | Cachet serveur       | false          | Entité initiale - Seal Certificate  |                    |
            | Formats de signature | ACTES - PAdES      | Cachet serveur auto          | false           | Cachet serveur       | true           | Entité initiale - Seal Certificate  |                    |
            ...
            | Formats de signature | PAdES              | Cachet serveur               | false           | Cachet serveur       | false          | Entité initiale - Seal Certificate  |                    |
            | Formats de signature | PAdES              | Cachet serveur auto          | false           | Cachet serveur       | true           | Entité initiale - Seal Certificate  |                    |
            | Formats de signature | PAdES              | Cachet serveur multidoc      | true            | Cachet serveur       | false          | Entité initiale - Seal Certificate  |                    |
            | Formats de signature | PAdES              | Cachet serveur multidoc auto | true            | Cachet serveur       | true           | Entité initiale - Seal Certificate  |                    |
