...
Feature: ArchiverDossier
    ...
    Scenario Outline: Purge d'un dossier (${archivageAction})
        ...
        * def params = karate.merge(__row, { username: "ws@legacy-bridge", password: "a123456a123456" })
...
"""
        ...
        * ip.pause(5)
        ...
        Given def params = karate.merge(__row, { archivageAction: "<archivageAction>", dossierId: dossierId, username: "ws@legacy-bridge", password: "a123456a123456" })
