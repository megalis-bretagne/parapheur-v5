...
[
    ...
    { "nom":"Service Web", "status":"NonLu", "annotation":"Emission du dossier" },
...
"""
    When def rv = call read('classpath:lib/ip/api/soap/requests/GetHistoDossier/getJsonHistoDossier.feature') karate.merge(params, defaults)
...
[
    ...
    { "nom":"Lukas Vermillon", "status":"CachetOK", "annotation":"Annotation publique lvermillon@legacy-bridge (cachet du dossier PAdES_cachet_1)"},
    { "nom":"Lukas Vermillon", "status":"Archive", "annotation":"Circuit terminé, dossier archivable"}
]
"""
    When def rv = call read('classpath:lib/ip/api/soap/requests/GetHistoDossier/getJsonHistoDossier.feature') karate.merge(params, defaults)
