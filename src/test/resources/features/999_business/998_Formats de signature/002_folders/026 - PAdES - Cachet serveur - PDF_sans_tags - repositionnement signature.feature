...
Feature: PAdES - Cachet serveur - PDF_sans_tags - repositionnement signature
    ...
    Scenario Outline: Création et démarrage du dossier par ${username}
        ...
        * v5.business.api.draft.createAndSendSimple(__row)
        ...
        Examples:
            ...
            | Formats de signature | ws-fds   | a123456  | WebService | [ { file: "PDF_sans_tags.pdf" } ] | PAdES | Cachet serveur | PAdES - Cachet serveur - PDF_sans_tags - repositionnement signature | démarrage  |
    ...
    Scenario Outline: Apposition du cacht serveur sur le dossier par "${username}" sur le bureau "${desktop}"
        ...
        * call read("classpath:lib/v5/business/api/folder/seal.feature") __row
        ...
        Examples:
            ...
            | Formats de signature | gnacarat | a123456  | Nacarat | PAdES - Cachet serveur - PDF_sans_tags - repositionnement signature | signature   | signature  | { "PDF_sans_tags.pdf": {"signatureNumber":0,"page":"1","x":200,"y":700} } |
    ...
    Scenario: Vérifications des documents du dossier par "ws-fds" en fin de circuit sur le bureau "WebService"
        ...
        * def download = v5.business.api.folder.download("Formats de signature", "WebService", "finished", "PAdES - Cachet serveur - PDF_sans_tags - repositionnement signature")
