...
Feature: Automatique - Signature - PDF_avec_tags
    ...
    Scenario Outline: Création et démarrage du dossier par ${username}
        ...
        * v5.business.api.draft.createAndSendSimple(__row)
        ...
        Examples:
            ...
            | Formats de signature | ws-fds   | a123456  | WebService | [ { file: "PDF_avec_tags.pdf" } ] | Automatique | Signature | Automatique - Signature - PDF_avec_tags | démarrage  |
    ...
    Scenario Outline: Signature du dossier par "${username}" sur le bureau "${desktop}"
        ...
        * call read("classpath:lib/v5/business/api/folder/sign.feature") __row
        ...
        Examples:
            ...
            | Formats de signature | gnacarat | a123456  | Nacarat | Automatique - Signature - PDF_avec_tags | signature   | signature  |
    ...
    Scenario: Vérifications des documents du dossier par "ws-fds" en fin de circuit sur le bureau "WebService"
        ...
        * def download = v5.business.api.folder.download("Formats de signature", "WebService", "finished", "Automatique - Signature - PDF_avec_tags")
