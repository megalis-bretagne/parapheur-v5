...
"""
    ...
    * def result = call read('classpath:lib/api/draft/create-and-send-multidoc-<withOrWithout>-annex.feature') folders
    ...
    Examples:
        ...
        | Marchés publics | ws-mp    | a123456  | WebService | Marché public | Service fait | ['classpath:files/pdf/main-1_1.pdf'] | Marché public %counter% | 1      | 10     | without       | {}     | création et démarrage depuis karate |
