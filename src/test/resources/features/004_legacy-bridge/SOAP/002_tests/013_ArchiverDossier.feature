...
"""
    ...
    * configure cookies = null
    ...
    Given header Authorization = api.soap.user.authorization("lvermillon@legacy-bridge", "a123456")
    And request
"""
<?xml version='1.0' encoding='utf-8'?>
<soap-env:Envelope xmlns:soap-env="http://schemas.xmlsoap.org/soap/envelope/">
    <soap-env:Body>
        <ns0:ForcerEtapeRequest xmlns:ns0="http://www.adullact.org/spring-ws/iparapheur/1.0">
            ...
            <ns0:CodeTransition>OK</ns0:CodeTransition>
...
"""
    ...
    Then status 200
    * def expectedMessage = archivageAction == 'ARCHIVER' ? 'Dossier ' + dossierId + ' archivé.' : 'Dossier ' + dossierId + ' supprimé du Parapheur.'
    And match /Envelope/Body/ArchiverDossierResponse/MessageRetour/codeRetour == 'OK'
    And match /Envelope/Body/ArchiverDossierResponse/MessageRetour/message == expectedMessage
