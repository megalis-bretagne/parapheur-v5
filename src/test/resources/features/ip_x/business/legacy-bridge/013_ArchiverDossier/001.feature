...
Feature: ArchiverDossier - Purge de iparapheur
...
"""
        * call read('classpath:lib/soap/requests/ForcerEtape/success.feature') params
        ...
        * pause(5)
        ...
        When def rv = call read('classpath:lib/soap/requests/ArchiverDossier/simple.feature') params
            ...
            And match rv.response == karate.read('classpath:lib/soap/schemas/ArchiverDossierResponse/OK.xml')
