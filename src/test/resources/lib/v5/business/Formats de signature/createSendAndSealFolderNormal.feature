...
Scenario: ...
    ...
    * call read("classpath:lib/v5/business/api/folder/seal.feature") karate.merge(defaults, { annotation: "signature", username: "fgarance", desktop: "Nacarat", folder: __arg.name + " - normal" }, __arg)
