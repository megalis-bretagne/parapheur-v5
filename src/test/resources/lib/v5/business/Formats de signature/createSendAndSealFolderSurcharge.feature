...
Scenario: ...
    ...
    * call read("classpath:lib/v5/business/api/folder/seal.feature") karate.merge(defaults, { annotation: "signature", username: "gnacarat", desktop: "Nacarat", folder: __arg.name + " - surcharge" }, __arg)
