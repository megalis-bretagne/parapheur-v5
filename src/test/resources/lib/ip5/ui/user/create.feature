...
Feature: UI user lib
    ...
    Scenario: Ajout d'un utilisateur
        ...
        When click("{^}Créer un utilisateur")
            ...
            And input(ip5.ui.locator.input("Prénom"), firstName)
            And input(ip5.ui.locator.input("E-mail"), email)
            And input(ip5.ui.locator.input("Nouveau mot de passe"), password)
            And input(ip5.ui.locator.input("Confirmer le mot de passe"), password)
